            ...
            >
              ...
              <Stack gap={4} flex="1">
                ...
                <Text fontSize="sm">
                  ...
                  Bằng AI là giải pháp toàn diện giúp người dùng tiếp cận
                  thông tin y tế nhanh chóng và chính xác, trước khi đến gặp bác
                  sĩ.
                </Text>

                <Heading size="sm">Hỗ Trợ Hỏi Đáp Về Bệnh</Heading>
                <Text fontSize="sm">
                  Chatbox AI giải đáp thắc mắc sức khỏe tức thì, không phải
                  chờ đợi.
                </Text>

                <Heading size="sm">Tư Vấn Sức Khỏe Cơ Bản</Heading>
                <Text fontSize="sm">
                  Cung cấp dấu hiệu bệnh, cách phòng tránh và điều trị cơ bản
                  (cảm cúm, đau đầu, dị ứng…).
                </Text>

                <Heading size="sm">Đánh Giá Triệu Chứng</Heading>
                <Text fontSize="sm">
                  Hỏi chi tiết triệu chứng, tiền sử, giúp người dùng có cái
                  nhìn tổng quan.
                </Text>
