        ...
        <VStack gap={8} align="stretch">
          ...
          <SimpleGrid columns={colCount} gap={6}>
            <Box bg="rgba(255,255,255,0.1)" p={6} borderRadius="md">
              ...
              <Text fontSize="md">
                Sử dụng thuật toán học máy để tự động phân loại hình ảnh y tế
                (X-quang, MRI, PET/CT), tiết kiệm thời gian và giảm thiểu sai
                sót trong phân loại thủ công.
              </Text>
            </Box>
            ...
            <Box bg="rgba(255,255,255,0.1)" p={6} borderRadius="md">
              ...
              <Text fontSize="md">
                Tự động phát hiện và làm nổi bật tổn thương, khối u hay bất
                thường, giúp bác sĩ tập trung vào vùng cần chú ý nhất.
              </Text>
            </Box>
            ...
            <Box bg="rgba(255,255,255,0.1)" p={6} borderRadius="md">
              ...
              <Text fontSize="md">
                Phân vùng hình ảnh thành các khu vực riêng biệt, cho phép phân
                tích chi tiết cấu trúc và chức năng của cơ quan.
              </Text>
            </Box>
          </SimpleGrid>
          ...
          <Flex align="center" justify="space-between" wrap="wrap" gap={4}>
            <VStack align="start" gap={3} flex="1">
              ...
              <Stack gap={2} pl={4} as="ul">
                <Text as="li">
                  Tiết kiệm thời gian, tập trung vào chẩn đoán
                </Text>
